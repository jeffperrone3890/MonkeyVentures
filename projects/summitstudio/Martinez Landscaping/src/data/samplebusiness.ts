 ...
 *  client (Martinez Landscaping). Swap this file to retarget the entire
 *  site at a different business — components never hardcode business
 *  content; they all read from here.
 * ─────────────────────────────────────────────────────────────────────────
