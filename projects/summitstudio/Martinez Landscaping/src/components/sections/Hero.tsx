  ...
  return (
    <section id="top" className="relative isolate flex min-h-[92svh] items-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-secondary/90 via-secondary/55 to-secondary/20" />
      ...
      <Container className="py-28 pt-36">
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-2xl">
          <motion.span
            variants={item}
            className="inline-flex items-center gap-2 rounded-full border border-surface-50/20 bg-surface-50/10 px-3.5 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-surface-50 backdrop-blur-sm"
          >
          ...
          <motion.h1
            variants={item}
            className="mt-6 font-display text-display-lg font-semibold text-surface-50"
          >
            Landscapes worth
            <br />
            coming home to.
          ...
          <motion.p variants={item} className="mt-6 max-w-xl text-lg leading-relaxed text-surface-50/85">
          ...
          <motion.div
            variants={item}
            className="mt-9 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-surface-50/90"
          >
